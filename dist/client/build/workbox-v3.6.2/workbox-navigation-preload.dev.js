...
undefined.workbox.navigationPreload = function (exports, logger_mjs) {
  'use strict';
  ...
  function disable() {
    if (isSupported()) {
      self.addEventListener('activate', function (event) {
        event.waitUntil(self.registration.navigationPreload.disable().then(function () {
          {
  ...
  */
  ...
  function enable(headerValue) {
    if (isSupported()) {
      self.addEventListener('activate', function (event) {
        event.waitUntil(self.registration.navigationPreload.enable().then(function () {
