...
undefined.workbox.broadcastUpdate = function (exports, WorkboxError_mjs, logger_mjs, assert_mjs) {
  'use strict';
  ...
  */
   ...
   * @memberof workbox.broadcastUpdate
   */
  var broadcastUpdate = function broadcastUpdate(channel, cacheName, url, source) {
  ...
  */
  ...
  var BroadcastCacheUpdate = function () {
     ...
     */
    function BroadcastCacheUpdate(channelName) {
      var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
          headersToCheck = _ref.headersToCheck,
          source = _ref.source;
    ...
    _createClass(BroadcastCacheUpdate, [{
      ...
      key: 'notifyIfUpdated',
      value: function notifyIfUpdated(firstResponse, secondResponse, url, cacheName) {
  ...
  */
  ...
  var Plugin = function () {
    ...
    * attribution value that indicates where the update originated.
    */
    function Plugin(channelName, options) {
    ...
    _createClass(Plugin, [{
      ...
      value: function cacheDidUpdate(_ref2) {
        var cacheName = _ref2.cacheName,
            oldResponse = _ref2.oldResponse,
            newResponse = _ref2.newResponse,
