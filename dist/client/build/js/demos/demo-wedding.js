 ...
 */
	$('#clock').countdown('2018/12/10 12:00:00').on('update.countdown', function (event) {
		var $this = $(this).html(event.strftime('' + '<span>%D<span>day%!d</span></span> ' + '<span>%H<span>hours</span></span> ' + '<span>%M<span>minutes</span></span> ' + '<span>%S<span>seconds</span></span> '));
	});
 ...
 */
	...
	var zoomHistoryGallery = function zoomHistoryGallery($wrapper) {
