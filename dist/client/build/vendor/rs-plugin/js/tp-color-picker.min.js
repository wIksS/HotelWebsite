...
window.RevColor = { defaultValue: "#ffffff", isColor: /(^#[0-9A-F]{6}$)|(^#[0-9A-F]{3}$)/i, get: function get(e) {
    return e ? RevColor.process(e, !0)[0] : "transparent";
  }, parse: function parse(e, r, a) {
    e = RevColor.process(e, !0);var t = [];return t[0] = r ? r + ": " + e[0] + ";" : e[0], a && (t[1] = e[1]), t;
  }, convert: function convert(e, r) {
    if (!e || "string" != typeof e) return RevColor.defaultValue;if ("transparent" === e) return e;if (-1 !== e.search(/\[\{/) || -1 !== e.search("gradient")) return RevColor.process(e, !0)[0];if (void 0 === r || isNaN(r)) return RevColor.process(e, !0)[0];if ((r = parseFloat(r)) <= 1 && (r *= 100), 0 === (r = Math.max(Math.min(parseInt(r, 10), 100), 0))) return "transparent";try {
  ...
  }, process: function process(e, r) {
    if ("string" != typeof e) return r && (e = RevColor.sanitizeGradient(e)), [RevColor.processGradient(e), "gradient", e];if ("transparent" === e.trim()) return ["transparent", "transparent"];if (-1 === e.search(/\[\{/)) return -1 !== e.search("#") ? [RevColor.sanitizeHex(e), "hex"] : -1 !== e.search("rgba") ? [e.replace(/\s/g, "").replace(/false/g, "1"), "rgba"] : -1 !== e.search("rgb") ? [e.replace(/\s/g, ""), "rgb"] : RevColor.isColor.test(e) ? [e, "hex"] : ["transparent", "transparent", !0];try {
      return e = JSON.parse(e.replace(/\&/g, '"')), r && (e = RevColor.sanitizeGradient(e)), [RevColor.processGradient(e), "gradient", e];
    } catch (e) {
      return console.log("RevColor.process() failed to parse JSON string"), ["linear-gradient(0deg, rgba(255, 255, 255, 1) 0%, rgba(0, 0, 0, 1) 100%)", "gradient", { type: "linear", angle: "0", colors: [{ r: "255", g: "255", b: "255", a: "1", position: "0", align: "bottom" }, { r: "0", g: "0", b: "0", a: "1", position: "100", align: "bottom" }] }];
    }
  }, transparentRgba: function transparentRgba(e, r) {
    return !(!r && "rgba" !== RevColor.process(e)[1]) && "0" === RevColor.rgbValues(e, 4)[3];
  }, rgbValues: function rgbValues(e, r) {
    3 === (e = e.substring(e.indexOf("(") + 1, e.lastIndexOf(")")).split(",")).length && 4 === r && (e[3] = "1");for (var a = 0; a < r; a++) {
      e[a] = e[a].trim();
    }return e;
  }, rgbaString: function rgbaString(e, r, a, t) {
    return "rgba(" + e + ", " + r + ", " + a + ", " + t + ")";
  }, rgbToHex: function rgbToHex(e) {
    var r = RevColor.rgbValues(e, 3);return RevColor.getRgbToHex(r[0], r[1], r[2]);
  }, rgbaToHex: function rgbaToHex(e) {
    var r = RevColor.rgbValues(e, 4);return [RevColor.getRgbToHex(r[0], r[1], r[2]), r[3]];
  }, getOpacity: function getOpacity(e) {
    return parseInt(100 * RevColor.rgbValues(e, 4)[3], 10) + "%";
  }, getRgbToHex: function getRgbToHex(e, r, a) {
    return "#" + ("0" + parseInt(e).toString(16)).slice(-2) + ("0" + parseInt(r).toString(16)).slice(-2) + ("0" + parseInt(a).toString(16)).slice(-2);
  }, joinToRgba: function joinToRgba(e) {
    return e = e.split("||"), RevColor.convert(e[0], e[1]);
  }, processRgba: function processRgba(e, r) {
    e = e.replace("#", "");var a = void 0 !== r,
        t = (a ? "rgba" : "rgb") + "(" + parseInt(e.substring(0, 2), 16) + ", " + parseInt(e.substring(2, 4), 16) + ", " + parseInt(e.substring(4, 6), 16);return t += a ? ", " + (.01 * parseInt(r, 10)).toFixed(2).replace(/\.?0*$/, "") + ")" : ")";
  }, processGradient: function processGradient(e) {
    for (var r, a = e.type, t = a + "-gradient(", i = "linear" === a ? e.angle + "deg, " : "ellipse at center, ", o = e.colors, c = o.length, n = "", s = 0; s < c; s++) {
      s > 0 && (n += ", "), n += "rgba(" + (r = o[s]).r + ", " + r.g + ", " + r.b + ", " + r.a + ") " + r.position + "%";
    }return t + i + n + ")";
  }, sanitizeHex: function sanitizeHex(e) {
    if (3 === (e = e.replace("#", "").trim()).length) {
      var r = e.charAt(0),
          a = e.charAt(1),
          t = e.charAt(2);e = r + r + a + a + t + t;
    }return "#" + e;
  }, sanitizeGradient: function sanitizeGradient(e) {
    for (var r, a = e.colors, t = a.length, i = [], o = 0; o < t; o++) {
      var c = a[o];delete c.align, r ? JSON.stringify(c) !== JSON.stringify(r) && (i[i.length] = c) : i[i.length] = c, r = c;
    }return e.colors = i, e;
  } }, function (e) {
  function r(e, r) {
    var a = (e = e.split("("))[0];e.shift();var t = e.join("(").split(",");return t.shift(), r = void 0 !== r ? r + "deg," : "ellipse at center,", a + "(" + r + t.join(",");
  }function a(e) {
    ...
    var o, c, n;if (e.isPlainObject(r)) {
      var s, l;for (var p in r) {
        r.hasOwnProperty(p) && ("string" == typeof (r = r[p]) ? ("gradient" === (r = RevColor.process(r))[1] && (s = (c = r[2]).angle, l = c.type), r = r[0]) : (s = r.angle, l = r.type), o = isNaN(p) ? p.replace(/_/g, " ").replace(/\b\w/g, function (e) {
          return e.toUpperCase();
        }) : "radial" !== l ? s + "&deg;" : "radial");
      }
    } else o = r;if ("blank" !== r) {
      e.isPlainObject(r) && (c = r, "", r = i || RevColor.processGradient(r));var v = '<span class="rev-cpicker-color tptip' + t + '" data-title="' + o + '" data-color="' + r + '"><span class="rev-cpicker-preset-tile"></span><span class="rev-cpicker-preset-bg" style="background: ' + r + '"></span>';return a || (v += '<span class="rev-cpicker-delete"><span class="rev-cpicker-delete-icon"></span></span>'), v += "</span>", n = e(v), c && n.data("gradient", c), n[0];
    }return n = document.createElement("span"), n.className = "rev-cpicker-color blank", n;
  }function l() {
    var r = c(this, "data-color").toLowerCase(),
        a = !kr && r === pr.toLowerCase();if (r === ir || a) {
      var t = e(this);return t.closest(".rev-cpicker-presets-group").find(".rev-cpicker-color.selected").removeClass("selected"), Cr = t, kr && !De && d(Cr.data("gradient"), !0), Cr.addClass("selected"), !1;
    }
  }function p(e, r) {
    ...
    }for (o = r.length, l = 0; l < o; l++) {
      a.appendChild(s(r[l], t, i));
    }return ["rev-cpicker-" + e, a];
  }function v(e, r, a) {
    if (dr) {
      if (!e) {
        var t = r || fe.val(),
            i = void 0 !== a ? a : sr.val();r = "transparent" === t ? "transparent" : "100%" === i ? RevColor.sanitizeHex(t) : RevColor.processRgba(t, i);
      }var o = "transparent" === r,
          c = o ? "" : r;e ? le.data("state", r) : ue.data("state", r), o ? dr.css("background", c) : dr[0].style.background = c, te && te(or, r), X.trigger("revcolorpickerupdate", [or, r]);
    }
  }function d(e, r) {
    var a = RevColor.process(e),
        t = a[1],
        i = a[0];if (K && se.removeClass("checked"), "gradient" !== t) {
      switch (t) {case "hex":
          e = RevColor.sanitizeHex(i), sr.val("100%"), G(100);break;case "rgba":
          var o = RevColor.rgbaToHex(i),
              c = parseInt(100 * o[1], 10);e = o[0], sr.val(c + "%"), G(c);break;case "rgb":
          e = RevColor.rgbToHex(i), sr.val("100%"), G(100);break;default:
          qe.click(), ue.click();}Ve.val(e).change(), r || ue.click();
    } else K ? (I(a[2]), N(), r || (We = !0, le.click())) : (Ve.val(RevColor.defaultValue).change(), ue.click());return [i, t];
  }function g(e, r) {
    var a,
        t = ee.slice(),
        i = t.length;for (t.sort(T); i--;) {
      if ((a = t[i]).align === e && a.x < r) return a;
    }i = t.length;for (var o = 0; o < i; o++) {
      if ((a = t[o]).align === e && a.x > r) return a;
    }
  }function b(r, a) {
    var t = g(r, a).color,
        i = u(t, r, !0),
        o = h(r, a, f(t, !0), i);xe && xe.removeClass("active"), xe = e(o).addClass("active").appendTo(Ze).draggable(Er), He = xe.children(".rev-cpicker-point-square")[0], Se = xe.children(".rev-cpicker-point-triangle")[0], Ue = Ze.children();var c = k(a);N(o), "bottom" === r && he.val(c[1]).change();
  }function k(e) {
    void 0 === e && (e = ee[Je].x);var r = xe.attr("data-color"),
        a = xe.hasClass("rev-cpicker-point-bottom");if (a) hr.hasClass("active") && (Qe.attr("disabled", "disabled"), Ye.attr("disabled", "disabled"), hr.removeClass("active")), r = RevColor.rgbaToHex(r)[0], ke.css("background", r), me.removeAttr("disabled").val(e + "%"), ce.find(".rev-cpicker-point-bottom").length > 2 && er.addClass("active"), ce.addClass("open");else {
      er.hasClass("active") && (ke.css("background", ""), me.attr("disabled", "disabled"), er.removeClass("active"));var t = RevColor.getOpacity(r);Qe.attr("data-opacity", t).val(t).removeAttr("disabled"), Ye.val(e + "%").removeAttr("disabled"), ce.find(".rev-cpicker-point-top").length > 2 && hr.addClass("active"), ce.removeClass("open");
    }return [a, r];
  }function u(e, r, a) {
    return "bottom" === r ? "rgb(" + e.r + "," + e.g + "," + e.b + ")" : "rgba(0, 0, 0, " + (a ? "1" : e.a) + ")";
  }function f(e, r) {
    var a = r ? "1" : e.a;return "rgba(" + e.r + "," + e.g + "," + e.b + "," + a + ")";
  }function m(e) {
    for (var r, a, t = document.createDocumentFragment(), i = e.length, o = 0; o < i; o++) {
      r = (a = e[o]).align, t.appendChild(h(r, a.position, f(a), u(a, r)));
    }Ue && Ue.draggable("destroy"), Ze.empty().append(t), Ue = Ze.children().draggable(Er);
  }function h(r, a, t, i) {
    var o = document.createElement("span");return o.className = "rev-cpicker-point rev-cpicker-point-" + r, "string" == typeof t ? o.setAttribute("data-color", t) : e(o).data("gradient", t), o.setAttribute("data-location", a), o.style.left = a + "%", o.innerHTML = "bottom" === r ? '<span class="rev-cpicker-point-triangle" style="border-bottom-color: ' + i + '"></span><span class="rev-cpicker-point-square" style="background: ' + i + '"></span>' : '<span class="rev-cpicker-point-square" style="background: ' + i + '"></span><span class="rev-cpicker-point-triangle" style="border-top-color: ' + i + '"></span>', o;
  }function C(e) {
    ...
    var r,
        ...
        o = i.length,
        c = Math.ceil(o / Hr),
        n = t * Hr;o += 1;for (var s = 0; s < c; s++) {
      var l = s * Hr,
          p = i.slice(l, parseInt(l + Hr, 10) - 1);Ce = !0, p.each(_), Ce && (o -= Hr) >= n && (p.remove(), r = !0);
    }return r;
  }function _() {
    if (-1 === this.className.search("blank")) return Ce = !1, !1;
  }function I(r) {
    var a = r.angle;"radial" === r.type && (a = "radial"), $e.removeClass("selected"), e('.rev-cpicker-orientation[data-direction="' + a + '"]').addClass("selected"), Q.val(C(a)), O(a), m(r.colors);
  }function N(e, r, t) {
    Oe = r, V(), Oe = !1;for (var i, o, c, n = [], s = ee.length, l = 0; l < s; l++) {
      o = (c = ee[l]).color, n[l] = o, (i = c.el).setAttribute("data-color", RevColor.rgbaString(o.r, o.g, o.b, o.a)), i.setAttribute("data-opacity", 100 * o.a), e && e === i && (Je = l);
    }re.hasClass("selected") ? (Ir.type = "radial", Ir.angle = "0") : (Ir.type = "linear", Ir.angle = parseInt(Q.val(), 10).toString()), Ir.colors = n, Cr && Cr.removeClass("selected");var p = RevColor.processGradient(Ir);if (v(!0, p), t) return [Ir, p];Ee.style.background = a(p), Ge.style.background = p;
  }function F(e, r) {
    if (0 === e) return !1;for (var a; e--;) {
      if ((a = ee[e]).align !== r) return a;
    }return !1;
  }function j(e, r, a) {
    if (e === a) return !1;for (var t; e++ < a;) {
    ...
    var t,
        i = r.alpha,
        o = a.alpha;t = i !== o ? A(e.x, r.x, a.x, i, o).toFixed(2) : i, e.alpha = t, e.color.a = t;
  }function S(e, r, a) {
    var t = e.color,
        i = r.color,
        o = a.color;if (r !== a) {
      var c = e.x,
          n = r.x,
          s = a.x;t.r = M(c, n, s, i.r, o.r), t.g = M(c, n, s, i.g, o.g), t.b = M(c, n, s, i.b, o.b);
    } else t.r = i.r, t.g = i.g, t.b = i.b;
  }function V() {
    ee = [], Fe = [], je = [], Ue.each(E), ee.sort(T);for (var e, r, a, t, i = ee.length, o = i - 1, c = 0; c < i; c++) {
      !1 === (r = F(c, a = (e = ee[c]).align)) && (r = j(c, a, o)), !1 === (t = j(c, a, o)) && (t = F(c, a)), "bottom" === a ? H(e, r, t) : S(e, r, t);
    }ee.sort(T);
  }function T(e, r) {
    ...
    var r = RevColor.rgbValues(c(this, "data-color"), 4),
        ...
        t = r[3].replace(/\.?0*$/, "") || 0,
        i = parseInt(this.style.left, 10);Oe && (i < 50 ? i += 2 * (50 - i) : i -= 2 * (i - 50), this.style.left = i + "%", this.setAttribute("data-location", i)), ee[e] = { el: this, x: i, alpha: t, align: a, color: { r: parseInt(r[0], 10), g: parseInt(r[1], 10), b: parseInt(r[2], 10), a: t, position: i, align: a } }, xe && xe[0] !== this && ("bottom" === a ? je[je.length] = i : Fe[Fe.length] = i);
  }function O(e) {
    ...
    var i,
        o,
        c = void 0 !== t,
        n = c ? t : parseInt(Q.val(), 10);if (r && "keyup" === r.type) i = !isNaN(n) && n >= -360 && n <= 360, o = n;else {
      var s = parseInt(Q.data("orig-value"), 10);n || (n = "0"), (isNaN(n) || n < -360 || n > 360) && (n = s), n !== s && (o = n, i = !0, Q.val(C(n)), c || (n = a || n, $e.removeClass("selected"), e('.rev-cpicker-orientation[data-direction="' + n + '"]').addClass("selected")));
    }(i || a) && (o && O(o), N());
  }function z() {
    ...
    var a = parseInt(100 * (Math.round(r.position.left) / (Nr - 2)).toFixed(2), 10);"bottom" === Ne ? me.val(a + "%").trigger("keyup") : Ye.val(a + "%").trigger("keyup");
  }function L() {
    var r = e(this);Ne = r.hasClass("rev-cpicker-point-bottom") ? "bottom" : "top", r.click();
  }function B() {
    ...
    ne || e.tpColorPicker(), wr = document.getElementById("rev-cpicker-current-edit"), Ge = document.getElementById("rev-cpicker-gradient-output"), Ee = document.getElementById("rev-cpicker-gradient-input"), ze = document.getElementById("rev-cpicker-edit-title"), Ae = document.createElement("textarea"), hr = e("#rev-cpicker-opacity-delete"), Ze = e("#rev-cpciker-point-container"), Ye = e("#rev-cpicker-opacity-location"), cr = e(".rev-cpicker-presets-group"), sr = e("#rev-cpicker-color-opacity"), re = e("#rev-cpicker-orientation-radial"), er = e("#rev-cpicker-color-delete"), Qe = e("#rev-cpicker-grad-opacity"), me = e("#rev-cpicker-color-location"), we = e("#rev-cpicker-gradients-core"), $e = e(".rev-cpicker-orientation"), he = e("#rev-cpicker-iris-gradient"), Be = e("#rev-cpicker-wheel-point"), Ke = e("#rev-cpicker-gradients"), Ve = e("#rev-cpicker-iris-color"), le = e("#rev-cpicker-gradient-btn"), pe = e("#rev-cpicker-gradient-hex"), qe = e("#rev-cpciker-clear-hex"), se = e("#rev-cpicker-meta-reverse"), Me = e("#rev-cpicker-hit-bottom"), xr = e("#rev-cpicker-scroll"), nr = e("#rev-cpicker-colors"), fe = e("#rev-cpicker-color-hex"), ue = e("#rev-cpicker-color-btn"), ke = e("#rev-cpicker-color-box"), Q = e("#rev-cpicker-meta-angle"), Le = e("#rev-cpicker-wheel"), ae = e("#rev-cpicker-hit-top"), mr = e("#rev-cpicker"), X = e(document), Er.drag = D, Er.stop = B, Er.start = L, ue.data("state", nr.find(".rev-cpicker-color").eq(0).attr("data-color") || "#ffffff"), le.data("state", Ke.find(".rev-cpicker-color").eq(0).attr("data-color") || "linear-gradient(0deg, rgba(255, 255, 255, 1) 0%, rgba(0, 0, 0, 1) 100%)"), mr.draggable({ containment: "window", handle: ".rev-cpicker-draggable", stop: function stop() {
      ...
      var r;if (De = -1 === this.id.search("gradient"), dr && (r = e(this).data("state")), De ? (dr && (ir = fe.val()), ce.removeClass("gradient-view").addClass("color-view")) : (dr && (ir = r), ce.removeClass("color-view").addClass("gradient-view"), We || we.children(".rev-cpicker-color").not(".blank").eq(0).click()), cr.perfectScrollbar("update"), r) {
        var a = "transparent" === r,
            t = a ? "" : r;a ? dr.css("background", t) : dr[0].style.background = t, kr = !0, e(".rev-cpicker-color").not(".blank").each(l), kr = !1, X.trigger("revcolorpickerupdate", [or, r]);
      }
    }), e("#rev-cpicker-check").on("click.revcipicker", function () {
      var r, a, t;if (ce.hasClass("color-view")) {
        var i = fe.val(),
            o = sr.val();or.removeData("gradient"), a = "transparent" === i ? "transparent" : "100%" === o ? RevColor.sanitizeHex(i) : RevColor.processRgba(i, o), r = [or, a, !1];
      } else {
        x();var c = N(!1, !1, !0),
            n = e.extend({}, c[0]),
            s = c[1];or.data("gradient", s), a = JSON.stringify(n).replace(/\"/g, "&"), r = [or, s, n];
      ...
      if (ce.hasClass("open")) {
        var a = r.target,
            t = e(a),
            i = a.id,
            o = -1 !== a.className.search("rev-cpicker-point") || "rev-cpicker-section-right" === i || -1 !== i.search("hit") || t.closest("#rev-cpicker-section-right, #rev-cpicker-point-wrap").length;o && ("text" === t.attr("type") ? o = !t.attr("disabled") : "rev-cpicker-check-gradient" === i && (o = !1)), o || x();
    ...
    }), e(".rev-cpicker-close").on("click.revcpicker", y), Ve.wpColorPicker({ palettes: !1, width: 267, border: !1, hide: !1, change: function change(e, r) {
        var a = r.color.toString();if (this.value = a, fe.val(a), !gr) {
          var t = sr.val();0 === parseInt(t, 10) && (a = "transparent"), v(!1, a, t), Cr && (Cr.removeClass("selected"), Cr = !1);
        }
      } }), he.wpColorPicker({ palettes: !1, height: 250, border: !1, hide: !1, change: function change(e, r) {
        var a = r.color.toString();this.value = a, pe.val(a), ke.css("background", a), He.style.backgroundColor = a, Se.style.borderBottomColor = a;var t = RevColor.processRgba(a, 100),
            i = RevColor.rgbValues(t, 4),
            o = Ir.colors[Je];o.r = i[0], o.g = i[1], o.b = i[2], o.a = i[3], xe.attr("data-color", t), N();
      } }), xr.slider({ orientation: "vertical", max: Tr, value: Tr, start: function start() {
        fr = "transparent" === fe.val();
      }, slide: function slide(e, r) {
        if (!yr) {
          var a,
              t = parseInt(100 * (r.value / Tr).toFixed(2), 10);fr && (a = t ? "#ffffff" : "transparent", fe.val(a)), 0 === t && (a = "transparent"), v(!1, a, t || "transparent"), sr.val(t + "%");
        }
      } }), e(".rev-cpicker-point-location").on("keyup.revcpicker focusout.revcpicker", function (e) {
      if (xe) {
        var r,
            a = xe.hasClass("rev-cpicker-point-bottom") ? "bottom" : "top",
            t = "bottom" === a ? je : Fe,
            i = "bottom" === a ? me : Ye,
            o = i.val().replace("%", "") || "0",
            c = e.type;for (isNaN(o) && (o = "keyup" === c ? "0" : xe.attr("data-location")), r = (o = Math.max(0, Math.min(100, parseInt(o, 10)))) < 50 ? 1 : -1; -1 !== t.indexOf(o);) {
          o += r;
      ...
      Ze.find(".rev-cpicker-point.active").removeClass("active"), xe = e(this).addClass("active"), He = xe.children(".rev-cpicker-point-square")[0], Se = xe.children(".rev-cpicker-point-triangle")[0], N(this), Cr = !1;var r = k();r[0] && he.val(r[1]).change();
      ...
      if (xe && xe.data("mousestart")) {
        var r = xe.data("mousestart"),
            a = e.pageY;xe.hasClass("rev-cpicker-point-bottom") ? a > r && a - r > Vr && er.hasClass("active") ? xe.addClass("warning") : xe.removeClass("warning") : r > a && r - a > Vr && hr.hasClass("active") ? xe.addClass("warning") : xe.removeClass("warning");
      }
    }).on("mouseup.revcpicker", function (e) {
      if (xe && xe.data("mousestart")) {
        var r = xe.data("mousestart"),
            a = e.pageY;xe.removeData("mousestart"), xe.hasClass("rev-cpicker-point-bottom") ? a > r && a - r > Sr && er.hasClass("active") ? er.click() : xe.removeClass("warning") : r > a && r - a > Sr && hr.hasClass("active") ? hr.click() : xe.removeClass("warning");
      }
    }).on("change.revcpicker", ".rev-cpicker-component", function () {
      var r = e(this),
          a = r.data("gradient") || r.val() || "transparent";("transparent" === a || RevColor.transparentRgba(a)) && (a = ""), r.data("tpcp").css("background", a);
    }).on("keypress.revcpicker", function (e) {
      if (ce.hasClass("active")) {
        var r = e.which;27 == r ? y() : 13 == r && de && de.blur();
      }
    }).on("click.revcpicker", ".rev-cpicker-color:not(.blank)", function () {
      if (Cr) {
        if (Cr[0] === this && Cr.hasClass("selected")) return;Cr.removeClass("selected");
      }var r = (Cr = e(this)).parent()[0].id,
          a = -1 !== r.search("core") ? "core" : "custom",
          t = -1 !== r.search("colors") ? "colors" : "gradients",
          i = e("#rev-cpicker-" + t + "-" + a + "-btn");if (i.hasClass("active") && i.find(".rev-cpicker-arrow-up").click(), ce.hasClass("color-view")) {
        var o = Cr.attr("data-color");gr = !0, Ve.val(o).change(), "transparent" === fe.val() && fe.val(o.toLowerCase()), gr = !1;var c = sr.val();0 === parseInt(c, 10) && (o = "transparent"), v(!1, o, c);
      } else ae.removeClass("full"), Me.removeClass("full"), d(Cr.data("gradient"), !0), se.removeClass("checked"), we.find(".rev-cpicker-color.selected").removeClass("selected");Cr.addClass("selected");
      ...
      if (oe) {
        if (window.confirm(document.getElementById("rev-cpicker-remove-delete").innerHTML)) {
          ce.addClass("onajax onajaxdelete");var r = e(this),
              a = r.parent(),
              t = a.attr("data-title") || "";if (!t) return void console.log("Preset does not have a name/title");var i = r.closest(".rev-cpicker-presets-group")[0].id,
              o = -1 !== i.search("colors") ? "colors" : "gradients";X.off("revcpicker_onajax_delete.revcpicker").on("revcpicker_onajax_delete.revcpicker", function (t, o) {
            o && console.log(o);var c = r.closest(".rev-cpicker-presets-group"),
                n = c.find(".ps-scrollbar-x-rail"),
                s = e("#" + i + "-btn");a.remove(), R.call(c[0]) ? c.perfectScrollbar("update") : e('<span class="rev-cpicker-color blank"></span>').insertBefore(n), w.call(c[0]) < Hr + 1 && (e('<span class="rev-cpicker-color blank"></span>').insertBefore(n), s.hasClass("active") && s.children(".rev-cpicker-arrow-up").click()), ce.removeClass("onajax onajaxdelete");
      ...
      if (oe) {
        var r,
            a,
            t = e(this),
            i = t.closest(".rev-cpicker-presets-save-as").find(".rev-cpicker-preset-save").val();if (i && isNaN(i)) {
          if (r = ce.hasClass("color-view") ? "colors" : "gradients", i = e.trim(i.replace(/\W+/g, "_")).replace(/^\_|\_$/g, "").toLowerCase(), e("#rev-cpicker-" + r + "-custom").find(".rev-cpicker-color").not(".blank").each(function () {
            ...
            ce.addClass("onajax onajaxsave");var o,
                n,
                l = {};if ("colors" === r) {
              var p = fe.val(),
                  v = sr.val();o = "transparent" === p ? "transparent" : "100%" === v ? RevColor.sanitizeHex(p) : RevColor.processRgba(p, v);
            } else n = Ge.style.background, o = e.extend({}, N(!1, !1, !0)[0]);l[i] = o, X.off("revcpicker_onajax_save.revcpicker").on("revcpicker_onajax_save.revcpicker", function (a, i) {
              if (i) return ce.removeClass("onajax onajaxsave"), void alert(t.attr("data-message"));var o = e(s(l, !1, " rev-picker-color-custom", n)),
                  c = e("#rev-cpicker-" + r + "-custom"),
                  p = c.find(".rev-cpicker-color.blank"),
                  v = e("#" + c[0].id + "-btn");p.length ? o.insertBefore(p.eq(0)) : o.insertBefore(c.find(".ps-scrollbar-x-rail")), e("#rev-cpicker-" + r + "-custom-btn").click(), w.call(c[0]) > 6 && (p.length && p.last().remove(), v.addClass("active").children(".rev-cpicker-arrow-down").click(), c.perfectScrollbar("update")), o.click(), ce.removeClass("onajax onajaxsave");
      ...
      var r = e(this),
          a = r.parent(),
          t = r.hasClass("active") ? "down" : "up";z.call(r.find(".rev-cpicker-arrow-" + t)[0]), a.find(".rev-cpicker-preset-title").removeClass("selected"), r.addClass("selected"), a.find(".rev-cpicker-presets-group").hide(), document.getElementById(this.id.replace("-btn", "")).style.display = "block", cr.perfectScrollbar("update");
      ...
      var r = e(this);r.data("orig-value", r.val());
    }), e(".rev-cpicker-hex").on("focusout.revcpicker", function () {
      var r, a, t;if ("rev-cpicker-color-hex" === this.id) {
        if (t = fe.val()) {
          if (t = RevColor.sanitizeHex(t), RevColor.isColor.test(t)) fe.val(t);else {
            if (r = e(this), !(a = r.data("orig-value"))) return void qe.click();t = a, fe.val(t);
          }
        } else t = "transparent";Ve.val(t).change();
      ...
      var r = e(this),
          a = r.attr("data-direction");$e.removeClass("selected"), r.addClass("selected"), "radial" !== a ? Q.removeAttr("disabled").val(C(a)) : Q.attr("disabled", "disabled"), P(!1, a);
      ...
      if (-1 !== this.className.search("active")) {
        var e = xe.hasClass("rev-cpicker-point-bottom") ? "bottom" : "top",
            r = ce.find(".rev-cpicker-point-" + e).length;r > 2 && (xe.draggable("destroy").remove(), Ue = Ze.children(), ce.click(), N()), r <= Fr && ("bottom" === e ? Me.removeClass("full") : ae.removeClass("full"));
      }
      ...
      var a,
          t = -1 === this.id.search("grad"),
          i = t ? sr : Qe,
          o = i.val().replace("%", ""),
          c = r.type;if (isNaN(o) && (o = "keyup" === c ? "0" : e(this).data("orig-value")), o = Math.max(0, Math.min(100, o)), "focusout" === c && (i.val(o + "%"), t || xe.attr("data-opacity", o)), t) v(!1, 0 === parseInt(o, 10) && "transparent", o), G(o);else {
        var n = RevColor.rgbValues(xe.attr("data-color"), 3),
            s = Ir.colors[Je];o = (.01 * parseInt(o, 10)).toFixed(2).replace(/\.?0*$/, ""), s.r = n[0], s.g = n[1], s.b = n[2], s.a = o, a = RevColor.rgbaString(s.r, s.g, s.b, o), xe.attr("data-color", a), N(), a = "rgba(0, 0, 0, " + o + ")", He.style.backgroundColor = a, Se.style.borderTopColor = a;
      }
    }).on("focusin.revcpicker", $), e(".rev-cpicker-builder-hit").on("click.revcpicker", function (e) {
      ee || V();for (var r = parseInt(100 * ((e.pageX - ae.offset().left) / Nr).toFixed(2), 10), a = -1 !== this.id.search("bottom") ? "bottom" : "top", t = "bottom" === a ? je : Fe, i = r < 50 ? 1 : -1; -1 !== t.indexOf(r);) {
        r += i;
    ...
    var a,
        ...
        n = e.extend({}, r),
        s = n.core || {},
        l = n.custom;!ar || l ? (o = 4, l = (ar = l) || { colors: [], gradients: [] }) : o = 2, s.colors || (s.colors = Pr), s.gradients || (s.gradients = zr);for (var v = 0; v < o; v++) {
      switch (v) {case 0:
          a = "colors-core", i = s.colors;break;case 1:
          a = "gradients-core", i = s.gradients;break;case 2:
          a = "colors-custom", i = l.colors;break;case 3:
          a = "gradients-custom", i = l.gradients;}t = p(a, i.slice() || []), (c = e("#" + t[0])).find(".rev-cpicker-color").remove(), c.prepend(t[1]);
    }
  }function W(e) {
  ...
  };var Dr = { refresh: function refresh() {
      var r = e(this);if (r.hasClass("rev-cpicker-component")) {
        var a = r.data("revcp") || {},
            t = r.val() || a.defaultValue || RevColor.defaultValue,
            i = RevColor.process(t);t = i[0], i = "rgba" === i[1] && RevColor.transparentRgba(t, !0) ? "" : t, "transparent" !== t ? r.data("tpcp")[0].style.background = i : r.data("tpcp").css("background", ""), r.attr("data-color", t).data("hex", t);
      }
    ...
    return r && "string" == typeof r ? this.each(Dr[r]) : this.each(function () {
      var a = e(this);if (a.hasClass("rev-cpicker-component")) a.tpColorPicker("refresh");else {
        var t,
            i,
            o = e('<span class="rev-colorpicker"></span>').data("revcolorinput", a),
            ...
            d = a.attr("data-skin"),
            g = a.val() || "",
            b = W(g);if (b && (g = b, a.val(b)), o.insertBefore(a).append([c, n, a]), r && e.isPlainObject(r)) {
          l || (l = r.wrapper), s || (s = r.wrapClasses), d || (d = r.skin), p || (p = r.wrapId), v || (v = r.title), i = r.defaultValue;var k = a.data("revcp");k && (r = e.extend({}, k, r)), a.data("revcp", r);
        }s || (s = Rr), s && o.addClass(s), p && o.attr("id", p), g || (g = i || RevColor.defaultValue, a.val(g)), g = (t = RevColor.process(g))[0], 3 === t.length && a.val(g), "transparent" !== (t = "rgba" === t[1] && RevColor.transparentRgba(g, !0) ? "" : g) && (c[0].style.background = t), n[0].innerHTML = v || Te || Or.color, a.attr({ type: "hidden", "data-color": g }).data("tpcp", c).addClass("rev-cpicker-component"), d && o.addClass(d), l ? (l = e(l).addClass("rev-cpicker-master-wrap"), o.wrap(l)) : o.addClass("rev-cpicker-master-wrap");var u = !!r && (r.init || ie);u && u(o, a, g, r);
      }
    });
  }, e(function () {
