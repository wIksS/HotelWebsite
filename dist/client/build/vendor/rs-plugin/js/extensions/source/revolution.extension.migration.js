...
(function ($) {
	...
	jQuery.extend(true, _R, {
		...
		// OUR PLUGIN HERE :)
		migration: function migration(container, options) {
	...
	var prepOptions = function prepOptions(o) {
		...
		if (o.disableProgressBar === undefined) o.disableProgressBar = o.hideTimerBar || "off";
		...
		if (o.sliderType === undefined) o.sliderType = "standard";

		if (o.fullScreen === "on") o.sliderLayout = "fullscreen";

		if (o.fullWidth === "on") o.sliderLayout = "fullwidth";

		if (o.sliderLayout === undefined) o.sliderLayout = "auto";
		...
		if (o.fallbacks == undefined) o.fallbacks = {
	...
	var prepLayerAnimations = function prepLayerAnimations(container, opt) {
		...
		container.find('.tp-caption').each(function () {
			...
			if (ncc.match("randomrotate")) cp.data('transform_in', c.randomrotate);else if (ncc.match(/\blfl\b/)) cp.data('transform_in', c.lfl);else if (ncc.match(/\blfr\b/)) cp.data('transform_in', c.lfr);else if (ncc.match(/\blft\b/)) cp.data('transform_in', c.lft);else if (ncc.match(/\blfb\b/)) cp.data('transform_in', c.lfb);else if (ncc.match(/\bsfl\b/)) cp.data('transform_in', c.sfl);else if (ncc.match(/\bsfr\b/)) cp.data('transform_in', c.sfr);else if (ncc.match(/\bsft\b/)) cp.data('transform_in', c.sft);else if (ncc.match(/\bsfb\b/)) cp.data('transform_in', c.sfb);else if (ncc.match(/\bskewfromleftshort\b/)) cp.data('transform_in', c.skewfromleftshort);else if (ncc.match(/\bskewfromrightshort\b/)) cp.data('transform_in', c.skewfromrightshort);else if (ncc.match(/\bskewfromleft\b/)) cp.data('transform_in', c.skewfromleft);else if (ncc.match(/\bskewfromright\b/)) cp.data('transform_in', c.skewfromright);else if (ncc.match(/\bfade\b/)) cp.data('transform_in', c.fade);

			if (ncc.match(/\brandomrotateout\b/)) cp.data('transform_out', c.randomrotate);else if (ncc.match(/\bltl\b/)) cp.data('transform_out', c.lfl);else if (ncc.match(/\bltr\b/)) cp.data('transform_out', c.lfr);else if (ncc.match(/\bltt\b/)) cp.data('transform_out', c.lft);else if (ncc.match(/\bltb\b/)) cp.data('transform_out', c.lfb);else if (ncc.match(/\bstl\b/)) cp.data('transform_out', c.sfl);else if (ncc.match(/\bstr\b/)) cp.data('transform_out', c.sfr);else if (ncc.match(/\bstt\b/)) cp.data('transform_out', c.sft);else if (ncc.match(/\bstb\b/)) cp.data('transform_out', c.sfb);else if (ncc.match(/\bskewtoleftshortout\b/)) cp.data('transform_out', c.skewfromleftshort);else if (ncc.match(/\bskewtorightshortout\b/)) cp.data('transform_out', c.skewfromrightshort);else if (ncc.match(/\bskewtoleftout\b/)) cp.data('transform_out', c.skewfromleft);else if (ncc.match(/\bskewtorightout\b/)) cp.data('transform_out', c.skewfromright);else if (ncc.match(/\bfadeout\b/)) cp.data('transform_out', c.fade);
