	...
	$.fn.visible = function (partial, hidden, direction, container) {
		...
		if (typeof t.getBoundingClientRect === 'function') {
			...
			var rec = t.getBoundingClientRect(),
			    ...
			    lViz = isContained ? rec.left - wPosition.left >= 0 && rec.left < vpWidth + wPosition.left - 100 : rec.left >= 0 && rec.left < vpWidth - 100,
			    rViz = isContained ? rec.right - wPosition.left > 0 && rec.right < vpWidth + wPosition.left - 100 : rec.right > 0 && rec.right <= vpWidth - 100,
