...
(function ($) {
	...
	jQuery.extend(true, _R, {
		...
		animateSlide: function animateSlide(nexttrans, comingtransition, container, nextli, actli, nextsh, actsh, mtl) {
	...
	// PREPARE THE SLIDE //
	//////////////////////
	var prepareOneSlide = function prepareOneSlide(slotholder, opt, visible, vorh) {
    ...
    opt.sloth = basicsize;*/
				...
				for (var j = 0; j < opt.slots; j++) {
					...
					for (var i = 0; i < opt.slots; i++) {
						...
						sh.append('<div class="slot" ' + 'style="position:absolute;' + 'top:' + (fullyoff + y) + 'px;' + 'left:' + (fulloff + x) + 'px;' + 'width:' + opt.slotw + 'px;' + 'height:' + opt.sloth + 'px;' + 'overflow:hidden;">' + '<div class="slotslide ' + mediafilter + '" data-x="' + x + '" data-y="' + y + '" ' + 'style="position:absolute;' + 'top:' + 0 + 'px;' + 'left:' + 0 + 'px;' + 'width:' + opt.slotw + 'px;' + 'height:' + opt.sloth + 'px;' + 'overflow:hidden;">' + '<div style="position:absolute;' + 'top:' + (0 - y) + 'px;' + 'left:' + (0 - x) + 'px;' + 'width:' + w + 'px;' + 'height:' + h + 'px;' + bgstyle + ';">' + '</div></div></div>');
						y = y + opt.sloth;
			...
			case "horizontal":
				...
				if (vorh == "horizontal") {
					...
					for (var i = 0; i < opt.slots; i++) {
						sh.append('<div class="slot" style="position:absolute;' + 'top:' + (0 + fullyoff) + 'px;' + 'left:' + (fulloff + i * opt.slotw) + 'px;' + 'overflow:hidden;width:' + (opt.slotw + 0.3) + 'px;' + 'height:' + h + 'px">' + '<div class="slotslide ' + mediafilter + '" style="position:absolute;' + 'top:0px;left:' + off + 'px;' + 'width:' + (opt.slotw + 0.6) + 'px;' + 'height:' + h + 'px;overflow:hidden;">' + '<div style="position:absolute;top:0px;' + 'left:' + (0 - i * opt.slotw) + 'px;' + 'width:' + w + 'px;height:' + h + 'px;' + bgstyle + ';">' + '</div></div></div>');
						if (scalestart != undefined && rotatestart != undefined) punchgs.TweenLite.set(sh.find('.slot').last(), { rotationZ: rotatestart });
					}
				} else {
					if (!visible) var off = 0 - opt.sloth;
					for (var i = 0; i < opt.slots + 2; i++) {
						sh.append('<div class="slot" style="position:absolute;' + 'top:' + (fullyoff + i * opt.sloth) + 'px;' + 'left:' + fulloff + 'px;' + 'overflow:hidden;' + 'width:' + w + 'px;' + 'height:' + opt.sloth + 'px">' + '<div class="slotslide ' + mediafilter + '" style="position:absolute;' + 'top:' + off + 'px;' + 'left:0px;width:' + w + 'px;' + 'height:' + opt.sloth + 'px;' + 'overflow:hidden;">' + '<div style="position:absolute;' + 'top:' + (0 - i * opt.sloth) + 'px;' + 'left:0px;' + 'width:' + w + 'px;height:' + h + 'px;' + bgstyle + ';">' + '</div></div></div>');
						if (scalestart != undefined && rotatestart != undefined) punchgs.TweenLite.set(sh.find('.slot').last(), { rotationZ: rotatestart });
					}
				}
				break;
	...
	var getSliderTransitionParameters = function getSliderTransitionParameters(container, comingtransition, nextsh, slidedirection) {
 ...
 *************************************/
	...
	var gSlideTransA = function gSlideTransA(a, i) {
		if (i == undefined || jQuery.isNumeric(a)) return a;
		if (a == undefined) return a;
		return a.split(",")[i];
	};

	var animateSlideIntern = function animateSlideIntern(nexttrans, comingtransition, container, nextli, actli, nextsh, actsh, mtl) {
		...
		if (nexttrans == 0) {
			...
			nextsh.find('.slotslide').each(function (j) {
				...
				mtl.add(punchgs.TweenLite.from(ss, masterspeed / 600, { opacity: 0, top: 0 - opt.sloth, left: 0 - opt.slotw, rotation: opt.rotate, force3D: "auto", ease: ei }), (j * 15 + curz * 30) / 1500);
			});
		}
		/////////////////////////////////////
		// THE SLOTSLIDE - TRANSITION I.  //
		...
		if (nexttrans == 1) {
			...
			nextsh.find('.slotslide').each(function (j) {
				...
				mtl.add(punchgs.TweenLite.from(ss, rand / 1000, { autoAlpha: 0, force3D: "auto", rotation: opt.rotate, ease: ei }), rand2 / 1000);
			});
		}
		...
		if (nexttrans == 4 || nexttrans == 5) {
			...
			nextsh.find('.slotslide').each(function (i) {
				...
				var del = i * cspeed / opt.slots;
				if (nexttrans == 5) del = (opt.slots - i - 1) * cspeed / opt.slots / 1.5;
				subtl.add(punchgs.TweenLite.from(ss, cspeed * 3, { top: 0 - opt.height, opacity: 0.5, rotation: opt.rotate, force3D: "auto", ease: punchgs.eo, delay: del }), 0);
				mtl.add(subtl, 0);
			});
		}
		...
		if (nexttrans == 6) {
			...
			nextsh.find('.slotslide').each(function (i) {
				...
				subtl.add(punchgs.TweenLite.from(ss, (masterspeed + tempo) / 1000, { top: 0 - opt.height, opacity: 1, force3D: "auto", rotation: opt.rotate, ease: eo }), 0);
				mtl.add(subtl, 0);
			});
		}
		...
		if (nexttrans == 9 || nexttrans == 10) {
			...
			nextsh.find('.slotslide').each(function (i) {
				var ss = jQuery(this);
				ssamount++;
				mtl.add(punchgs.TweenLite.fromTo(ss, masterspeed / 2000, { autoAlpha: 0, force3D: "auto", transformPerspective: 600 }, { autoAlpha: 1, ease: ei, delay: i * opt.slots / 100 / 2000 }), 0);
			});
		}
		...
		//nexttrans = 34;
		if (nexttrans == 31 || nexttrans == 32 || nexttrans == 33 || nexttrans == 34) {
			//mtl.add(punchgs.TweenLite.set(nextsh.find('.defaultimg'),{autoAlpha:0}),0);border:1px solid #fff

			var moveCircles = function moveCircles(cont, ms, _nt, dir, ei) {
			...
			mas = ms - ms / 5, _nt = nexttrans, fy = _nt == 31 ? "+100%" : _nt == 32 ? "-100%" : "0%", fx = _nt == 33 ? "+100%" : _nt == 34 ? "-100%" : "0%", ty = _nt == 31 ? "-100%" : _nt == 32 ? "+100%" : "0%", tx = _nt == 33 ? "-100%" : _nt == 34 ? "+100%" : "0%", mtl.add(punchgs.TweenLite.fromTo(actsh, ms - ms * 0.2, { y: 0, x: 0 }, { y: ty, x: tx, ease: eo }), ms * 0.2);
		...
		if (nexttrans == 11) {
			...
			switch (specials) {
				...
				case 12:
					...
					if (jQuery.inArray(specials, [6, 8, 10]) >= 0) mtl.add(punchgs.TweenLite.fromTo(actsh, masterspeed / 1000, { autoAlpha: 1, filter: __ft, "-webkit-filter": __ft }, { autoAlpha: 0, force3D: "auto", ease: ei, filter: __ff, "-webkit-filter": __ff }), 0);
		...
		if (nexttrans == 12 || nexttrans == 13 || nexttrans == 14 || nexttrans == 15) {
			...
			if (specials != 1) switch (nexttrans) {
				case 12:
		...
		if (nexttrans == 16) {
			...
			mtl.add(punchgs.TweenLite.fromTo(actli.find('.tp-half-one'), masterspeed / 800, { width: oow, height: ooh / 2, position: 'absolute', top: '0px', left: '0px', force3D: "auto", transformOrigin: "center top" }, { scale: sc1, rotation: ro1, y: 0 - ooh - ooh / 4, autoAlpha: 0, ease: ei }), 0);
			mtl.add(punchgs.TweenLite.fromTo(actli.find('.tp-half-two'), masterspeed / 800, { width: oow, height: ooh, overflow: 'hidden', position: 'absolute', top: ooh / 2, left: '0px', force3D: "auto", transformOrigin: "center bottom" }, { scale: sc2, rotation: ro2, y: ooh + ooh / 4, ease: ei, autoAlpha: 0, onComplete: function onComplete() {
					// CLEAN UP
			...
			if (actli.html() != null) mtl.add(punchgs.TweenLite.fromTo(nextli, (masterspeed - 200) / 1000, { scale: sc3, x: opt.width / 4 * xof, y: ooh / 4 * yof, rotation: ro3, force3D: "auto", transformOrigin: "center center", ease: eo }, { autoAlpha: 1, scale: 1, x: 0, y: 0, rotation: 0 }), 0);
		...
		if (nexttrans == 17) {
			...
			nextsh.find('.slotslide').each(function (j) {
				...
				mtl.add(punchgs.TweenLite.fromTo(ss, masterspeed / 800, { opacity: 0, rotationY: 0, scale: 0.9, rotationX: -110, force3D: "auto", transformPerspective: 600, transformOrigin: "center center" }, { opacity: 1, top: 0, left: 0, scale: 1, rotation: 0, rotationX: 0, force3D: "auto", rotationY: 0, ease: ei, delay: j * 0.06 }), 0);
			});
		}
		...
		if (nexttrans == 18) {
			...
			nextsh.find('.slotslide').each(function (j) {
				...
				mtl.add(punchgs.TweenLite.fromTo(ss, masterspeed / 500, { autoAlpha: 0, rotationY: 110, scale: 0.9, rotationX: 10, force3D: "auto", transformPerspective: 600, transformOrigin: "center center" }, { autoAlpha: 1, top: 0, left: 0, scale: 1, rotation: 0, rotationX: 0, force3D: "auto", rotationY: 0, ease: ei, delay: j * 0.06 }), 0);
			});
		}
		...
		if (nexttrans == 20) {
			...
			nextsh.find('.slotslide').each(function (j) {
				...
				mtl.add(punchgs.TweenLite.fromTo(ss, masterspeed / 1000, { left: ofx, rotationX: 40, z: -600, opacity: op, top: 0, scale: 1, force3D: "auto", transformPerspective: 600, transformOrigin: torig, transformStyle: "flat", rotationY: rot }, { left: 0, rotationX: 0, opacity: 1, top: 0, z: 0, scale: 1, rotationY: 0, delay: d, ease: ei }), 0);
			});
			actsh.find('.slotslide').each(function (j) {
				var ss = jQuery(this),
				    d = j * 50 / 1000;
				...
				mtl.add(punchgs.TweenLite.fromTo(ss, masterspeed / 1000, { opacity: 1, rotationX: 0, top: 0, z: 0, scale: 1, left: 0, force3D: "auto", transformPerspective: 600, transformOrigin: torig, transformStyle: "flat", rotationY: 0 }, { opacity: 1, rotationX: 20, top: 0, z: -600, left: ofx, force3D: "auto", rotationY: rot, delay: d, ease: eo }), 0);
			});
		}
		...
		if (nexttrans == 21 || nexttrans == 25) {
			...
			nextsh.find('.slotslide').each(function (j) {
				...
				mtl.add(punchgs.TweenLite.fromTo(ss, ms2 * 2 / 1000, { left: 0, transformStyle: "flat", rotationX: rot2, z: 0, autoAlpha: 0, top: 0, scale: 1, force3D: "auto", transformPerspective: 1200, transformOrigin: torig, rotationY: rot }, { left: 0, rotationX: 0, top: 0, z: 0, autoAlpha: 1, scale: 1, rotationY: 0, force3D: "auto", delay: ms2 / 1000, ease: ei }), 0);
			});
			...
			actsh.find('.slotslide').each(function (j) {
				var ss = jQuery(this);
				mtl.add(punchgs.TweenLite.fromTo(ss, masterspeed / 1000, { left: 0, transformStyle: "flat", rotationX: 0, z: 0, autoAlpha: 1, top: 0, scale: 1, force3D: "auto", transformPerspective: 1200, transformOrigin: torig, rotationY: 0 }, { left: 0, rotationX: rot2, top: 0, z: 0, autoAlpha: 1, force3D: "auto", scale: 1, rotationY: rot, ease: eo }), 0);
			});
		}
		...
		if (nexttrans == 23 || nexttrans == 24) {
			...
			nextsh.find('.slotslide').each(function (j) {
				var ss = jQuery(this);
				mtl.add(punchgs.TweenLite.fromTo(ss, masterspeed / 1000, { left: opx, rotationX: opt.rotate, force3D: "auto", opacity: op, top: 0, scale: 1, transformPerspective: 1200, transformOrigin: torig, rotationY: rot }, { left: 0, rotationX: 0, autoAlpha: 1, top: 0, z: 0, scale: 1, rotationY: 0, delay: j * 50 / 500, ease: ei }), 0);
			});
			...
			actsh.find('.slotslide').each(function (j) {
				var ss = jQuery(this);
				mtl.add(punchgs.TweenLite.fromTo(ss, masterspeed / 1000, { left: 0, rotationX: 0, top: 0, z: 0, scale: 1, force3D: "auto", transformStyle: "flat", transformPerspective: 1200, transformOrigin: torig, rotationY: 0 }, { left: opx, rotationX: opt.rotate, top: 0, scale: 1, rotationY: rot, delay: j * 50 / 500, ease: eo }), 0);
