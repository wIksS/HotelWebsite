...
;(function ($, window, undefined) {
	...
	$.Flipshow.prototype = {
		...
		_layout: function _layout($current, $next) {
		...
		_navigate: function _navigate($nav, dir) {
		...
		_flip: function _flip($currentItem, $nextItem, dir, angle) {
		...
		_ontransitionend: function _ontransitionend($nextItem) {
			$nextItem.show();
