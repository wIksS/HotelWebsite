...
!function (a) {
  "use strict";
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = a(window.jQuery) : "function" == typeof define && define.amd ? define(["jquery"], a) : window.jQuery && !window.jQuery.fn.colorpicker && a(window.jQuery);
}(function (a) {
  "use strict";
  var b = function b(_b, c) {
    ...
    var c = arguments,
      ...
      var f = a(this),
          ...
          h = "object" == (typeof b === "undefined" ? "undefined" : _typeof(b)) ? b : {};g || "string" == typeof b ? "string" == typeof b && (e = g[b].apply(g, Array.prototype.slice.call(c, 1))) : f.data("colorpicker", new d(this, h));
