 ...
 */
	if ($('#countdown').get(0)) {
		...
		$('#countdown').countdown(countdown_date).on('update.countdown', function (event) {
			var $this = $(this).html(event.strftime(countdown_title + '<span class="days custom-secondary-font"><span class="text-color-primary">%D</span> Day%!d</span> ' + '<span class="hours custom-secondary-font"><span class="text-color-primary">%H</span> Hrs</span> ' + '<span class="minutes custom-secondary-font"><span class="text-color-primary">%M</span> Min</span> ' + '<span class="seconds custom-secondary-font"><span class="text-color-primary">%S</span> Sec</span> '));
		});
	}
