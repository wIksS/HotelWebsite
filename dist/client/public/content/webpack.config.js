...
module.exports = function (webpackEnv) {
  ...
  var publicPath = isEnvProduction ? paths.servedPath : isEnvDevelopment && '/';
  ...
  var publicUrl = isEnvProduction ? publicPath.slice(0, -1) : isEnvDevelopment && '';
  ...
  return {
    ...
    output: {
      ...
      devtoolModuleFilenameTemplate: isEnvProduction ? function (info) {
        return path.relative(paths.appSrc, info.absoluteResourcePath).replace(/\\/g, '/');
      } : isEnvDevelopment && function (info) {
    ...
    new HtmlWebpackPlugin(Object.assign({}, {
    ...
    } : undefined)), new HtmlWebpackPlugin({
      inject: true,
      template: paths.appHtml
      ...
      filename: 'hotel-house-rates.html',
      template: 'public/hotel-house-rates.html'
    }), new HtmlWebpackPlugin({
      filename: 'hotel-rooms-rates.html',
      template: 'public/hotel-rooms-rates.html'
    }), new HtmlWebpackPlugin({
      filename: 'hotel-house-rates-detail.html',
      template: 'public/hotel-house-rates-detail.html'
    }), new HtmlWebpackPlugin({
      filename: 'hotel-rooms-rates-detail.html',
      template: 'public/hotel-rooms-rates-detail.html'
    }), new HtmlWebpackPlugin({
      filename: 'hotel-book.html',
      template: 'public/hotel-book.html'
    }), new HtmlWebpackPlugin({
      filename: 'hotel-gallery.html',
      template: 'public/hotel-gallery.html'
    }), new HtmlWebpackPlugin({
      filename: 'hotel-location.html',
      template: 'public/hotel-location.html'
    }), new HtmlWebpackPlugin({
      filename: 'hotel-special-offers.html',
      template: 'public/hotel-special-offers.html'
    }),
